import projectJson from '$project-data/project.json';
import mainScriptJson from '$project-data/scripts/light-delay-main-short.json';
import festivalScriptJson from '$project-data/scripts/light-delay-festival.json';
import trailerScriptJson from '$project-data/scripts/light-delay-trailer.json';
import longScriptJson from '$project-data/scripts/light-delay-long.json';
import masterNarrativeScriptJson from '$project-data/scripts/light-delay-master-narrative.json';
import festivalMasterScriptJson from '$project-data/scripts/light-delay-festival-master.json';
import trailerMasterScriptJson from '$project-data/scripts/light-delay-trailer-master.json';
import assetsJson from '$project-data/assets.json';
import charactersJson from '$project-data/characters.json';
import locationsJson from '$project-data/locations.json';
import objectsJson from '$project-data/objects.json';
import vehiclesJson from '$project-data/vehicles.json';
import factionsJson from '$project-data/factions.json';
import voiceProfilesJson from '$project-data/voice-profiles.json';
import documentsJson from '$project-data/documents.json';
import narrativeFunctionsJson from '$project-data/narrative-functions.json';
import entityVariantsJson from '$project-data/entity-variants.json';
import comparisonTaxonomyJson from '$project-data/comparison-taxonomy.json';
import editorialLifecycleJson from '$project-data/editorial-lifecycle.json';
import assetGenerationManifestJson from '$project-data/production/asset-generation-manifest.json';
...
const outlineGlob = import.meta.glob('$project-data/outlines/*.json', {
	eager: true,
	import: 'default'
