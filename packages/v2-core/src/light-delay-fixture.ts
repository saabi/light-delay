...
export function withHarlanBlocking(snapshot:WorldSnapshot):WorldSnapshot{return {...snapshot,occupancy:[...snapshot.occupancy,{entityId:ids.harlan,nodeId:ids.stations,blocksTraversal:true,reason:'Harlan occupies the crew-stations passage and blocks traversal.'}]};}
