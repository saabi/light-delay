...
- **Problema vigente:** los 57 cues de acción duplicados ya fueron archivados. Main y Festival superan el ledger causal y Festival ya tiene shot list A–G con 67 tomas; el largo continúa como tratamiento sin tomas. Los informes actuales todavía señalan deuda de binding, performance, propósito/framing y placements —principalmente en material previo a E–G— que debe revisarse por valor editorial, no rellenarse por volumen.
