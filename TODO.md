...
- **Problema vigente:** los 57 cues de acción duplicados ya fueron archivados. Main y Festival superan el ledger causal; Festival tiene shot list A–G con 67 tomas y ya cerró propósito, bindings y contextos de producción en A–G. El largo continúa como tratamiento sin tomas. La deuda estructural medida se concentra ahora en main y tráiler, además de performance/muestras de voz y decisiones editoriales; debe revisarse por valor editorial, no rellenarse por volumen.
