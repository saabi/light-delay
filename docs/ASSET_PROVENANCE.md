...
- **143 imágenes registradas** en `data/assets.json`.
...
- 38 imágenes de referencia para personajes, localizaciones, vehículos, objetos, escala, presentación y bloqueo 3D.
...
- 138 de 143 assets no tienen objeto `source`;
- los 143 carecen de modelo/versionado exacto verificable;
