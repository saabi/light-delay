...
- **484 assets registrados** en `data/assets.json` (incluidos 104 frames de animatic archivados, 104 stills de storyboard del Festival Master, 1 fotograma negro del tráiler-master, 44 referencias, 1 placeholder y los recursos de voz registrados).
...
- 44 imágenes de referencia para personajes, localizaciones, vehículos, objetos, escala, presentación y bloqueo 3D.
