...
- **481 assets registrados** en `data/assets.json` (incluidos 104 frames de animatic archivados, 103 stills de storyboard del Festival Master, 44 referencias, 1 placeholder y los recursos de voz registrados).
