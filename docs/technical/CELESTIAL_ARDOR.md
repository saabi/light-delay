...
La pared curva visible del puente es el **casco presurizado**, acabado en gris estructural: no es una pared de cristal, un ventanal panorámico ni una pantalla envolvente. Una serie escasa de ventanas pequeñas puede distribuirse a lo largo del cilindro, siempre entre costillas y lejos de uniones críticas. Cada abertura debe ser profunda, de varias capas, con marco estructural grueso y obturador exterior/interior; en conjunto ocupan una fracción mínima de la pared. Sirven para orientación, inspección y contacto visual ocasional, no para pilotaje rutinario. El azul queda restringido a los displays de los seis puestos.

Aunque sigue siendo una nave mantenible y funcional, el puente es un espacio de ocupación prolongada. Las superficies dominantes son paneles compuestos mate en gris claro y blanco cálido, con acentos apagados azul pizarra/verde azulado, piso antideslizante grafito, tapicería técnica y superficies de contacto reemplazables. El metal queda visible en estructura, uniones, pasamanos y herrajes. La iluminación general es neutra y uniforme, con tareas ligeramente más cálidas en la mesa; no debe parecer una sala industrial oscura ni un interior de lujo.

Las dos escaleras conservan barandas interiores y añaden **barandas exteriores continuas en cada borde expuesto**, incluidos descansos y curvas sobre el hueco central. Los balaustres y pasamanos siguen la hélice sin dejar caídas abiertas; sólo se interrumpen en las aberturas funcionales ya fijadas junto al cilindro de servicio y el pozo de ascensor.

El puente es un recinto circular con **seis puestos de tripulación en arco**, una **silla de capitán independiente** y una **mesa de reunión para seis** en el lado opuesto. Una escalera helicoidal rodea el hueco central. La abertura de su baranda desemboca junto al cilindro de servicio; la abertura de la segunda escalera queda junto al pozo de ascensor. Estas relaciones sirven a la circulación general y no intervienen en la secuencia de Harlan.
...
- [x] ~~Ventanas de observación del puente (§6 "Cubierta de mando").~~ Resueltas como una serie escasa de aberturas pequeñas y reforzadas en el casco cilíndrico; nunca como ventanal panorámico — ver arriba.
- [x] Descanso de mando (`location:celestial-ardor-command-vestibule`): las dos aberturas de baranda desembocan respectivamente junto al cilindro de servicio y al pozo de ascensor; la escotilla de servicio permanece fuera de la línea visual normal de los puestos, según `data/locations.json`.
