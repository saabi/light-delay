...
- **Contenido narrativo bilingüe:** los cuatro scripts, diálogos, subtítulos derivados, escenas, beats, tomas, assets, taxonomía de comparación, funciones y variantes se localizan mediante `data/translations/public.en.json`. La cobertura exacta vigente de 1070 cadenas se valida en CI; el inglés está en `draft`, el español conserva autoridad y las rutas EN/ES eligen su idioma por defecto sin sobrescribir una selección manual persistida.
