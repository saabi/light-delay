...
- **Completitud de metadatos de toma:** Main tiene propósito y encuadre en sus 124 tomas; Festival conserva sus 67 tomas completas; el generador y JSON del tráiler cubren propósito y encuadre en sus 29 tomas sin heredar spoilers. La deuda restante está separada en bindings, placements, performance y subcampos avanzados de cámara.
