...
- **Documentación reconciliada:** fuentes activas saneadas contra los JSON y el estado 3D vigente; 17 escenas de historia (+ título/créditos), 128 tomas/takes, 100 frames legacy y 132 imágenes quedan diferenciados.
