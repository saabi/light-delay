...
- **Deuda visual del animatic:** inventario provisional de 208 candidatos `needs_regeneration` (112 main + 67 Festival + 29 tráiler) y 12 placeholders main `needs_replacement`. La producción visual queda bloqueada hasta aprobar ritmo, encuadres, referencias y freeze por cut; informes en `npm run report:editorial`.
...
- **Multi-script / Festival Cut (ADR-0001 Accepted):** festival tiene 7 escenas y **67 tomas** A–G. Las 29 tomas E–G completan evidencia, override, cuarentena, contacto y cierre con stills reutilizados como placeholders; no se generaron medios.
