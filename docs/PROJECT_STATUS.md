...
- Expanded browser compatibility to 15 tests with hydration waits; preserved stale narrative-copy assertions in the separate data audit. Current data has 85 shots while the legacy assertion expects 94 (the dated production history records 94→90→85); see the pre-M2 integration audit in `V2_ARCHITECTURE_INDEX.md`.
