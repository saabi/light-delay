...
const rows = [
	...
	[
		...
		3,
		'El mensaje de Zao',
		'La tripulación escucha fragmentos del mensaje. La firma prueba origen y hora del dispositivo, no todavía la verdad de cada palabra.',
		'location:celestial-ardor-bridge',
	...
	[
		...
		3,
		'Decisión de Okoye',
		'Okoye elige ejecutar la orden de Voss bajo evidencia incompleta mientras seguridad contiene a Harlan sin convertir la escena en combate armado.',
		'location:diplomatic-core-room',
	...
	[
		...
		'El archivo de Zao queda preservado y Harlan bajo custodia. La transmisión hacia la Tierra parte, pero sus consecuencias permanecen fuera de campo.',
		'location:celestial-ardor-bridge',
...
const canonClaims = [
	...
	[
		...
		'El relé físico, el mensaje óptico y el saludo pasivo forman evidencia complementaria.'
	],
	[
		'canon:sorell-status',
